"""
Django settings for caixas project.
...
ALLOWED_HOSTS = ['viralizacred.pythonanywhere.com', 'localhost']
...
WSGI_APPLICATION = 'caixas.wsgi.application'
